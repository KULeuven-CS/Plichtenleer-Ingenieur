...
\begin{answer}[Dieter]
	...
	Ze moeten niet beoefend worden omdat het een plicht is (zoals in deontologistische ethiek) maar omdat leden van een instituut door hun omgeving gestimuleerd worden tot het uitmintend beoefenen van een gemeenschappelijke praktijk.
	In het beoefenen van die praktijk vinden ze voldoening en dienen het algemeen belang.
	Bovendien kan de deugdenethiek ook de rolintegriteit (rol van ingenieur) overschreiden.
...
\end{question}
\begin{answer}[Dieter]
	De verantwoordelijkheid is vaak gedeeld en mag niet zomaar overgelaten worden aan enkel het bedrijf.
	Kwaliteit kan 
\end{answer}
